...
public class FileDownloadSuccess implements DTOInterfaces.SUCCESS_RESPONSE_DTO, DTOInterfaces.ID, DTOInterfaces.NAME, DTOInterfaces.MIME_TYPE, DTOInterfaces.ENCODING, DTOInterfaces.CONTENT {
  private Long id;
  private String name;
  ...
  public FileDownloadSuccess() {
  }

  public FileDownloadSuccess(Long id, String name, String mimeType, String encoding, byte[] content) {
    this.id = id;
    this.name = name;
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof FileDownloadSuccess that)) return false;
